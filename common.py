...
# print(preprocessing(text, remove_punctuation=False, remove_stopwords=True, normalisation=False))
# print(preprocessing(text, remove_punctuation=False, remove_stopwords=True, normalisation=True))
# print(preprocessing(text, remove_punctuation=True, remove_stopwords=False, normalisation=False))
# print(preprocessing(text, remove_punctuation=True, remove_stopwords=False, normalisation=True))
# print(preprocessing(text, remove_punctuation=True, remove_stopwords=True, normalisation=False))
# print(preprocessing(text, remove_punctuation=True, remove_stopwords=True, normalisation=True))
