...
keys = ['#путешествие', '#животные', '#спорт', '#наука', '#стиль', '#музыка', '#искусство',
        '#еда', '#фитнес', '#автомобиль', '#юмор', '#архитектура', '#рукоделие', '#танцы', '#тв', '#ногти',
        '#дизайн', '#игры']
# keys = ['путешествие', 'животные', 'спорт', 'наука', 'стиль', 'музыка', 'искусство',
#         'еда', 'фитнес', 'автомобиль', 'юмор', 'архитектура', 'рукоделие', 'танцы', 'тв', 'ногти',
#         'дизайн', 'игры']
...
# modelPath = '../hashtagnword2vec/trained_models/only_hashtags/200hashtags/hnw2v.model'
